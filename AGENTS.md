...
- `specs`: internal normative specifications for framework-level contracts
...
- Edit specifications under `specs/**`; English `*.md` files are the source, and matching `.zh.md` mirrors should be kept in sync
