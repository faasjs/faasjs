...
- Do not directly edit Markdown under `packages/*/{classes,functions,interfaces,type-aliases,variables}`; update JSDoc in `packages/*/src` and regenerate with `vp run doc` instead
