...
import {
  Descriptions, DescriptionsProps, Space
} from 'antd'
...
import {
  FaasItemProps, transferOptions, transferValue, UnionFaasItemElement, UnionFaasItemRender
} from './data'
...
function DescriptionItemContent<T = any> (props: DescriptionItemContentProps<T>): JSX.Element {
  ...
  if (computedProps.extendTypes && computedProps.extendTypes[computedProps.item.type])
    if (computedProps.extendTypes[computedProps.item.type].children)
      ...
      return <>{computedProps.extendTypes[computedProps.item.type].render(computedProps.value, computedProps.values, 0, 'description')}</>
    else
