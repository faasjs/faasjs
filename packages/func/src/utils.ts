 ...
 *
 * This function detects the current Node.js runtime (either 'mjs' or 'cjs') and loads the specified package accordingly.
 *
 ...
 * @throws {Error} If the runtime is neither 'mjs' nor 'cjs'.
 */
